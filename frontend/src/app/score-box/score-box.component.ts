...
export class ScoreBoxComponent implements OnInit ,OnDestroy {
  ...
  console.log("final scorelist " , this.scorelist)
  console.log("final live",this.liveScoreList)
  ...
  getInfoCricketScores() {
    this.apiservic.getInfoCricketScores(this.matchId).subscribe((res: any) => {
     ...
     console.log("scorelist this" , this.scorelist)
